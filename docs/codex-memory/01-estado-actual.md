...
- **Pasada de UX/UI & Desaturación Visual en Pagos V3 (2026-08-25)**: Erradicación del ruido visual en la barra de búsqueda (eliminados botones de auto 15s y refresh manual), unificación a un solo ribbon visible de Estados de Cobro, eliminación del chip de Pickup (modelo exclusivo Torre GGA y Torre Valcob), entrega directa con formato conciso por torre y depto, y fecha dinámica con rayito ⚡ (`Zap`) para hoy vs. calendario 📅 (`CalendarDays`) con fecha real para pedidos posteriores.

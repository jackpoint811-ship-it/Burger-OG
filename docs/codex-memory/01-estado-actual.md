...
- **Skills Especializadas de Cloudflare Ops y GitHub Workflow (2026-08-25)**: Creación de `.agents/skills/cloudflare-ops/` (consultas D1, inspección R2, dev server y live tail) con scripts auxiliares ejecutables, y `.agents/skills/github-workflow/` (reglas de branching, commits semánticos quirúrgicos, auditoría de PRs sin contaminación cruzada y ciclo de sincronización post-merge).

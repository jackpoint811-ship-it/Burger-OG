 ...
 * - Transferencias SPEI: Total recaudado por SPEI + clic para filtrar transferencias.
 * - Efectivo en Entrega: Total en efectivo + clic para filtrar efectivo.
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3">
      ...
      <div
        ...
        title="Clic para filtrar únicamente transferencias SPEI"
        role="button"
        tabIndex={0}
      >
        <div className="flex items-center justify-between">
      ...
      >
        ...
        <div className="flex items-baseline justify-between gap-2">
          ...
          <span className="text-[11px] font-bold text-text-secondary">
            {financialSummary.pendingTransferCount} por validar
          </span>
        </div>
      </div>
    </div>
